...
_G.LogoHub = "rbxassetid://11262159835"
_G.LoadText = "Loading Interface . . ."
_G.LoadText2 = "Suck Script Version : 1.0.0"
_G.LoadText3 = "Welcome to Suck Script | Premium Edition"
_G.HeadText = "Attack Hub"
...
function LoadFunction()
	...
	LoadButton.MouseButton1Down:Connect(function()
		if LoadFocus == false then
			...
			Logo.Position = UDim2.new(0, 20, 0, 11)
			Logo.Size = UDim2.new(0, 28, 0, 28)
			Logo.Image = _G.LogoHub
		end
	end)
end
...
function Library.new()
	...
	function Library.Notifcation(options)
		...
		Line2.Name = "Line2"
		Line2.Parent = Line1
		Line2.BackgroundColor3 = _G.Color
	...
	function LibraryTab.tab(options)
		...
		function LibraryPage.page()
			...
			function LibraryFunction.Line()
				...
				Line.AnchorPoint = Vector2.new(0.5, 0.5)
				Line.BackgroundColor3 = _G.Color --Color3.fromRGB(255, 255, 255)
			...
			function LibraryFunction.Seperator(options)
			
			local NameTitleSep = options.Title or "Seperator"
			...
			Seperator.Parent = ScrollingPageFrame
			Seperator.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
			Seperator.BackgroundTransparency = 1.000
			Seperator.Size = UDim2.new(0, 478, 0, 20)
			...
			function LibraryFunction.Slider(options)
				...
				SliderValueFrame_2.BackgroundColor3 = _G.Color
				...
				SliderValueFrame_3.BackgroundColor3 = _G.Color
...
local ColorLabel = Page_Main.Label({
		Title = "Color Label"
	})
ColorLabel.Color(Color3.fromRGB(124, 249, 185))
...
local Multi = Page_Main.MultiDropdown({
...
Page_Main.Button({
	...
	callback = function()
		Multi.Clear()
		wait(.5)
		Multi.Add(math.random(1,5))
end
})

Page_Main.TextBox({
	Title = "Text Box",
	PlaceHolder = "It Text Box",
	callback = function(value)
		print(value)
end
})
